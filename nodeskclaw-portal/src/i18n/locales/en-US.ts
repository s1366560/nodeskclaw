const enUS = {
  ...
  geneMarketDialog: {
    title: "Gene Market",
    learnForInstance: "Learn for this instance",
  ...
  instanceMembers: {
    ...
    subtitle: "Manage instance members and access permissions",
  ...
  channel: {
    ...
    saving: "Saving...",
    restartingHint: "OpenClaw is finishing current tasks and restarting...",
    ...
    emptyHint: "No available channels detected, make sure the instance is running",
    loadFailed: "Failed to load channel configs",
    saveSuccess: "Channel config saved, OpenClaw restarted",
    restartTimeout: "Config saved, but OpenClaw restart timed out, please check instance status",
    saved: "Config saved",
  ...
  enterpriseFiles: {
    ...
    allAgents: "All Agents",
    browsable: "Browsable",
    notRunning: "Instance is not running, files cannot be browsed",
    noAgents: "No agent instances",
    ...
    connectionLost: "Instance connection lost",
  ...
  instanceFiles: {
    ...
    confirmMessage: "Modifying {path} will directly affect the running instance. Some config changes may require a restart to take effect. Are you sure you want to save?",
