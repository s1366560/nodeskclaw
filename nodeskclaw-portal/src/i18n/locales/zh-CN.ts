const zhCN = {
  ...
  channel: {
    ...
    saving: "保存中...",
    restartingHint: "OpenClaw 正在完成当前任务并重启...",
    configured: "已配置",
    ...
    uploading: "上传中...",
    deployRepo: "从项目仓库部署",
    emptyHint: "未检测到可用 Channel，请确认实例正在运行",
    loadFailed: "加载 Channel 配置失败",
    saveSuccess: "Channel 配置已保存，OpenClaw 已重启",
    restartTimeout: "配置已保存，但 OpenClaw 重启超时，请检查实例状态",
    saved: "配置已保存",
    saveFailed: "保存失败",
  ...
  instanceFiles: {
    ...
    preview: "预览",
    confirmTitle: "确认保存文件",
    confirmMessage: "修改 {path} 的内容将直接影响当前运行中的实例。部分配置变更可能需要重启实例才能生效。确定保存吗？",
    confirmSave: "确认保存",
    saveSuccess: "文件保存成功",
    saveFailed: "文件保存失败",
    filterPlaceholder: "按文件名过滤...",
